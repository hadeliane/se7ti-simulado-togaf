const questions = [ 
    {
        "QUESTION_NUMBER": "1",
        "QUESTION_TEXT": "Qual é o propósito dos Princípios de Arquitetura?",
        "POSSIBLE_ANSWERS": [
        ...
        "EXPLANATION_TEXT": "Explicação: O propósito dos Princípios de Arquitetura é prover uma base de referência para guiar a tomada de decisões no nível corporativo e alinhar as iniciativas de TI com os objetivos estratégicos da organização.",
        "CORRECT_ANSWER": "B",
        "JSONINDEX": "1",
        "Probability": 1,
	"versions": ["9","10"],
...
{
    "QUESTION_NUMBER": "2",
    "QUESTION_TEXT": "Qual elemento não faz parte do template recomendado para Princípios de Arquitetura?",
    "POSSIBLE_ANSWERS": [
        "A. Nome do Princípio.",
        "B. Justificativa.",
    ...
    "EXPLANATION_TEXT": "Explicação: O template recomendado para Princípios de Arquitetura inclui Nome, Declaração, Justificativa e Implicações. O item 'Descrição do Cenário Atual' não faz parte desse modelo.",
    "CORRECT_ANSWER": "C",
    "JSONINDEX": "2",
    "Probability": 1,
    "versions": ["9","10"],
...
{
    "QUESTION_NUMBER": "3",
    "QUESTION_TEXT": "Qual das opções abaixo caracteriza um bom Princípio de Arquitetura?",
    "POSSIBLE_ANSWERS": [
    ...
    "EXPLANATION_TEXT": "Explicação: Um bom Princípio de Arquitetura deve ser claro, específico, consistente com os objetivos estratégicos e capaz de orientar decisões arquiteturais de forma eficaz.",
    "CORRECT_ANSWER": "A",
    "JSONINDEX": "3",
    "Probability": 1,
    "versions": ["9","10"],
...
{
    "QUESTION_NUMBER": "4",
    "QUESTION_TEXT": "Quais são as características essenciais de um bom Princípio de Arquitetura?",
    "POSSIBLE_ANSWERS": [
    ...
    "EXPLANATION_TEXT": "Explicação: Um bom Princípio de Arquitetura deve ser relevante para a organização, específico em sua aplicação, e fornecer justificativa e implicações claras para orientar decisões.",
    "CORRECT_ANSWER": "A",
    "JSONINDEX": "4",
    "Probability": 1,
    "versions": ["9","10"],
...
{
    "QUESTION_NUMBER": "5",
    "QUESTION_TEXT": "Como o Padrão TOGAF recomenda descrever as Implicações de um Princípio de Arquitetura?",
    "POSSIBLE_ANSWERS": [
    ...
    "EXPLANATION_TEXT": "Explicação: O TOGAF recomenda que as Implicações sejam detalhadas, abordando como o princípio afetará os processos, custos e decisões futuras.",
    "CORRECT_ANSWER": "B",
    "JSONINDEX": "5",
    "Probability": 1,
    "versions": ["9","10"],
...
{
    "QUESTION_NUMBER": "6",
    "QUESTION_TEXT": "Qual das opções abaixo corresponde corretamente a um elemento do template recomendado para Princípios de Arquitetura?",
    "POSSIBLE_ANSWERS": [
    ...
    "EXPLANATION_TEXT": "Explicação: O template recomendado para Princípios de Arquitetura no TOGAF inclui os seguintes elementos: Nome, Declaração, Justificativa e Implicações. Esses componentes asseguram que os princípios sejam claros, objetivos e aplicáveis.",
    "CORRECT_ANSWER": "A",
    "JSONINDEX": "6",
    "Probability": 1,
    "versions": ["9","10"],
...
{
    "QUESTION_NUMBER": "7",
    "QUESTION_TEXT": "Ao criar um bom Princípio de Arquitetura, qual das características abaixo é ESSENCIAL, segundo o Padrão TOGAF?",
    "POSSIBLE_ANSWERS": [
    ...
    "EXPLANATION_TEXT": "Explicação: Um bom Princípio de Arquitetura deve ser relevante para a organização, compreensível para os stakeholders e consistente com os objetivos estratégicos. Isso garante que ele sirva como uma diretriz eficaz.",
    "CORRECT_ANSWER": "B",
    "JSONINDEX": "7",
    "Probability": 1,
    "versions": ["9","10"],
...
{
    "QUESTION_NUMBER": "8",
    "QUESTION_TEXT": "No template recomendado pelo Padrão TOGAF para Princípios de Arquitetura, o que deve ser descrito na seção 'Declaração'?",
    "POSSIBLE_ANSWERS": [
    ...
    "EXPLANATION_TEXT": "Explicação: No template do TOGAF, a 'Declaração' deve descrever o Princípio de Arquitetura de forma breve e clara, geralmente em uma única frase, capturando sua essência e objetivo.",
    "CORRECT_ANSWER": "B",
    "JSONINDEX": "8",
    "Probability": 1,
    "versions": ["9","10"],
...

{
    ...
    "EXPLANATION_TEXT": "Explicação: A Avaliação de Prontidão para Transformação do Negócio avalia fatores como maturidade da governança organizacional, cultura e capacidades que podem influenciar o sucesso da transformação.",
    "CORRECT_ANSWER": "B",
    "JSONINDEX": "11",
    "Probability": 1,
    "versions": ["9","10"],
...

{
    ...
    "EXPLANATION_TEXT": "Explicação: O principal benefício dessa avaliação é identificar e mitigar riscos que podem impactar a transformação, aumentando a probabilidade de sucesso da iniciativa estratégica.",
    "CORRECT_ANSWER": "B",
    "JSONINDEX": "13",
    "Probability": 1,
    "versions": ["9","10"],
...

{
    ...
    "EXPLANATION_TEXT": "Explicação: O principal objetivo da Análise de Diferenças é identificar lacunas, riscos e oportunidades ao comparar a arquitetura linha de base com a arquitetura alvo, apoiando o planejamento das mudanças organizacionais.",
    "CORRECT_ANSWER": "A",
    "JSONINDEX": "15",
    "Probability": 1,
    "versions": ["9","10"],
...

{
    ...
    "EXPLANATION_TEXT": "Explicação: Um aspecto central da Análise de Diferenças é a comparação entre os componentes das arquiteturas linha de base e futura, permitindo avaliar os impactos das mudanças no contexto organizacional.",
    "CORRECT_ANSWER": "B",
    "JSONINDEX": "16",
    "Probability": 1,
    "versions": ["9","10"],
...

{
    ...
    "EXPLANATION_TEXT": "Explicação: O Padrão TOGAF® define interoperabilidade como a capacidade de diferentes sistemas ou organizações trabalharem juntos de forma eficiente e efetiva, garantindo a troca adequada de informações e a execução integrada de processos.",
    "CORRECT_ANSWER": "B",
    "JSONINDEX": "18",
    "Probability": 1,
    "versions": ["9","10"],
...

{
    ...
    "EXPLANATION_TEXT": "Explicação: O Padrão TOGAF® descreve diferentes aspectos da interoperabilidade, incluindo os níveis operacional, de informações e técnico, que juntos garantem a integração entre organizações, processos, dados e sistemas.",
    "CORRECT_ANSWER": "A",
    "JSONINDEX": "19",
    "Probability": 1,
    "versions": ["9","10"],
...

{
    ...
    "EXPLANATION_TEXT": "Explicação: Um dos principais desafios da interoperabilidade é alinhar os diferentes domínios da arquitetura, garantindo que dados, aplicações e processos funcionem de forma integrada e coerente.",
    "CORRECT_ANSWER": "D",
    "JSONINDEX": "20",
    "Probability": 1,
    "versions": ["9","10"],
...

{
    ...
    "EXPLANATION_TEXT": "Explicação: O Padrão TOGAF® é amplamente utilizado como framework de Arquitetura Corporativa porque oferece um método comprovado, testado e flexível, que pode ser adaptado a diferentes contextos organizacionais.",
    "CORRECT_ANSWER": "C",
    "JSONINDEX": "21",
    "Probability": 1,
    "versions": ["9","10"],
...

{
    ...
    "EXPLANATION_TEXT": "Explicação: Um dos principais benefícios do Padrão TOGAF® é oferecer uma linguagem comum e uma estrutura que facilitam a comunicação, a colaboração e a coerência na condução das iniciativas de Arquitetura Corporativa.",
    "CORRECT_ANSWER": "C",
    "JSONINDEX": "22",
    "Probability": 1,
    "versions": ["9","10"],
...

{
    ...
    "EXPLANATION_TEXT": "Explicação: O Padrão TOGAF® não é prescritivo. Ele fornece diretrizes e métodos que podem e devem ser ajustados para atender à realidade de cada organização.",
    "CORRECT_ANSWER": "C",
    "JSONINDEX": "23",
    "Probability": 1,
    "versions": ["9","10"],
...
{
    "QUESTION_NUMBER": "25",
    "QUESTION_TEXT": "Em qual componente são fornecidas orientações práticas sobre como usar o Padrão TOGAF para necessidades específicas?",
    "POSSIBLE_ANSWERS": [
    ...
    "EXPLANATION_TEXT": "Explicação: A orientação prática sobre como aplicar o Padrão TOGAF® está nos TOGAF Series Guides, que complementam o conteúdo essencial com exemplos, práticas específicas e variações por contexto.",
    "CORRECT_ANSWER": "B",
    "JSONINDEX": "25",
    "Probability": 1,
    "versions": ["10"],
...

{
    ...
    "EXPLANATION_TEXT": "Explicação: O Padrão TOGAF® é organizado como um conjunto modular de documentos, permitindo que diferentes componentes sejam utilizados de forma independente ou combinada, conforme o contexto e as necessidades da organização.",
    "CORRECT_ANSWER": "A",
    "JSONINDEX": "26",
    "Probability": 1,
    "versions": ["9","10"],
...

{
    ...
    "EXPLANATION_TEXT": "Explicação: A organização do Padrão TOGAF® em diferentes documentos permite tratar assuntos de forma modular, aprofundar temas específicos e possibilitar a adoção gradual e adaptada à realidade de cada organização.",
    "CORRECT_ANSWER": "D",
    "JSONINDEX": "27",
    "Probability": 1,
    "versions": ["9","10"],
...

{
    ...
    "POSSIBLE_ANSWERS": [
        ...
        "B. A criação de visões com catálogos e matrizes para uso em todas as fases do MDA.",
    ...
    "EXPLANATION_TEXT": "Explicação: A Fase Preliminar descreve as atividades de preparação e iniciação necessárias para estabelecer a Capacidade de Arquitetura, incluindo a customização do Padrão TOGAF® e a definição de Princípios de Arquitetura.",
    "CORRECT_ANSWER": "C",
    "JSONINDEX": "28",
    "Probability": 1,
    "versions": ["9","10"],
...
{
    "QUESTION_NUMBER": "30",
    "QUESTION_TEXT": "Em que momento a Fase Preliminar deve ser revisitada dentro do ciclo do MDA?",
    "POSSIBLE_ANSWERS": [
...

{
    ...
    "POSSIBLE_ANSWERS": [
        ...
        "C. Identificação das partes interessadas relevantes.",
        "D. Implementação das soluções propostas."
    ],
    "EXPLANATION_TEXT": "Explicação: A implementação das soluções ocorre após as fases de planejamento e governança. A Fase A está focada em definir a proposta em alto nível e obter o alinhamento necessário para seguir com o desenvolvimento da arquitetura.",
    "CORRECT_ANSWER": "D",
    "JSONINDEX": "32",
    "Probability": 1,
    "versions": ["9","10"],
...
{
    "QUESTION_NUMBER": "33",
    "QUESTION_TEXT": "Qual é o principal objetivo da Fase B, segundo o Padrão TOGAF®?",
    "POSSIBLE_ANSWERS": [
...
{
    "QUESTION_NUMBER": "35",
    "QUESTION_TEXT": "O que é desenvolvido nas Fases B, C e D, segundo o Padrão TOGAF®?",
    "POSSIBLE_ANSWERS": [
        "A. A definição da Visão da Arquitetura e das partes interessadas envolvidas.",
        ...
        "D. A avaliação de riscos técnicos e o planejamento de mitigação."
    ],
    "EXPLANATION_TEXT": "Explicação: Nas Fases B, C e D são desenvolvidas as arquiteturas linha de base (estado atual) e alvo (estado futuro) para cada domínio, servindo de base para a análise de diferenças e para o planejamento das etapas seguintes do MDA (Método de Desenvolvimento da Arquitetura).",
    "CORRECT_ANSWER": "C",
    "JSONINDEX": "35",
    "Probability": 1,
    "versions": ["9","10"],
...

{
    ...
    "EXPLANATION_TEXT": "Explicação: A Fase F (Plano de Migração) trata do planejamento detalhado de como a organização irá sair da arquitetura linha de base e alcançar a arquitetura alvo por meio de um plano estruturado de implementação e migração.",
    "CORRECT_ANSWER": "C",
    "JSONINDEX": "36",
    "Probability": 1,
    "versions": ["9","10"],
...
{
    "QUESTION_NUMBER": "38",
    "QUESTION_TEXT": "Qual é a principal finalidade da Fase F, segundo o Padrão TOGAF®?",
    "POSSIBLE_ANSWERS": [
    ...
    "EXPLANATION_TEXT": "Explicação: A Fase F (Plano de Migração) detalha o plano de implementação e migração, organizando a sequência de iniciativas necessárias para alcançar a arquitetura alvo a partir da arquitetura linha de base.",
    "CORRECT_ANSWER": "B",
    "JSONINDEX": "38",
    "Probability": 1,
    "versions": ["9","10"],
...
{
    "QUESTION_NUMBER": "39",
    "QUESTION_TEXT": "Quais fases do MDA são responsáveis por converter a arquitetura alvo planejada em ações concretas para a futura implementação, segundo o Padrão TOGAF®?",
    "POSSIBLE_ANSWERS": [
        "A. Fases A e G",
        "B. Fases D e H",
        "C. Fases E e F",
    ...
    "EXPLANATION_TEXT": "Explicação: As Fases E (Oportunidades e Soluções) e F (Plano de Migração) fazem a transição entre o planejamento arquitetural e a execução, identificando soluções e organizando a sequência de implementação para atingir a arquitetura alvo.",
    "CORRECT_ANSWER": "C",
    "JSONINDEX": "39",
    "Probability": 1,
    "versions": ["9","10"],
...
{
    "QUESTION_NUMBER": "42",
    "QUESTION_TEXT": "Durante qual fase do MDA o arquiteto corporativo exerce supervisão para assegurar que a solução seja implementada conforme o planejado?",
    "POSSIBLE_ANSWERS": [
        "A. Fase D",
        "B. Fase E",
        "C. Fase F",
...
{
    "QUESTION_NUMBER": "45",
    "QUESTION_TEXT": "O que a fase de Gerenciamento de Requisitos busca garantir no ciclo do MDA, segundo o Padrão TOGAF®?",
    "POSSIBLE_ANSWERS": [
...
{
    "QUESTION_NUMBER": "46",
    "QUESTION_TEXT": "Durante qual fase do MDA se estabelecem os procedimentos para adaptar a arquitetura já implantada?",
    "POSSIBLE_ANSWERS": [
        "A. Fase A",
        "B. Fase C",
        "C. Fase G",
...
{
    "QUESTION_NUMBER": "48",
    "QUESTION_TEXT": "Qual das afirmações representa corretamente o papel da Fase H do Padrão TOGAF®?",
    "POSSIBLE_ANSWERS": [
...

{
  ...
  "EXPLANATION_TEXT": "Explicação: O Panorama de Arquitetura (Architecture Landscape) tem como função apoiar a identificação e a reutilização de blocos de construção de arquitetura em diferentes projetos e estágios da arquitetura.",
  "CORRECT_ANSWER": "B",
  "JSONINDEX": "49",
  "Probability": 1,
  "versions": ["10"],
  ...
  "subject": "Panorama de Arquitetura"
},
{
  "QUESTION_NUMBER": "50",
  ...
  "EXPLANATION_TEXT": "Explicação: O Panorama de Arquitetura (Architecture Landscape) apoia a tomada de decisões ao fornecer uma visão dinâmica, integrada e evolutiva da arquitetura corporativa em seus diversos estados.",
  "CORRECT_ANSWER": "B",
  "JSONINDEX": "50",
  "Probability": 1,
  "versions": ["10"],
...
//
{
  ...
  "EXPLANATION_TEXT": "Explicação: O Padrão TOGAF® define a Arquitetura Corporativa como uma forma de descrever o estado futuro da organização, permitindo orientar as mudanças necessárias para alcançar suas metas e objetivos.",
  "CORRECT_ANSWER": "C",
  "JSONINDEX": "53",
  "Probability": 1,
  "versions": ["10"],
...
},
{
  ...
  "EXPLANATION_TEXT": "Explicação: A arquitetura usada para apoiar um projeto tem como foco detalhar requisitos, identificar sinergias e dependências futuras, assegurar conformidade com a governança e promover alinhamento entre projetos.",
  "CORRECT_ANSWER": "C",
  "JSONINDEX": "54",
  "Probability": 1,
  "versions": ["10"],
...
},
{
  ...
  "EXPLANATION_TEXT": "Explicação: A arquitetura para apoiar a entrega de soluções é altamente detalhada e tem foco em restrições, controles e requisitos para o projeto, servindo como estrutura de governança para a mudança.",
  "CORRECT_ANSWER": "A",
  "JSONINDEX": "55",
  "Probability": 1,
  "versions": ["10"],
...
},
{
  ...
  "EXPLANATION_TEXT": "Explicação: Os quatro propósitos principais de uma Capacidade de Arquitetura, segundo o Padrão TOGAF®, são: apoiar a estratégia, o portfólio, os projetos e a entrega de soluções.",
  "CORRECT_ANSWER": "B",
  "JSONINDEX": "56",
  "Probability": 1,
  "versions": ["10"],
...
},
{
  ...
  "EXPLANATION_TEXT": "Explicação: A arquitetura para apoiar a estratégia é menos detalhada e voltada ao longo prazo (tipicamente de 3 a 10 anos), enquanto a arquitetura para apoiar projetos é mais detalhada e aplicada a prazos mais curtos (geralmente até 2 anos).",
  "CORRECT_ANSWER": "C",
  "JSONINDEX": "57",
  "Probability": 1,
  "versions": ["10"],
...
},
{
  ...
  "EXPLANATION_TEXT": "Explicação: A descrição corresponde ao conceito de bloco de construção (Building Block): um pacote de funcionalidades com limites definidos, reconhecível, montável, decomposto e reutilizável.",
  "CORRECT_ANSWER": "B",
  "JSONINDEX": "71",
  "Probability": 1,
  "versions": ["9","10"],
...
{
  "QUESTION_NUMBER": "77",
  "QUESTION_TEXT": "Segundo o Padrão TOGAF®, de que forma o Repositório de Arquitetura apoia o entendimento e a colaboração entre diferentes níveis da organização?",
  "POSSIBLE_ANSWERS": [
    "A. Impõe um único nível de abstração para todos os artefatos de arquitetura.",
    "B. Armazena diferentes classes de resultados arquiteturais, em múltiplos níveis de abstração.",
...
},
{
  ...
  "EXPLANATION_TEXT": "Explicação: O Metamodelo Corporativo representa os tipos de entidades que aparecem nos modelos que descrevem a empresa e os relacionamentos entre essas entidades.",
  "CORRECT_ANSWER": "D",
  "JSONINDEX": "81",
  "Probability": 1,
  "versions": ["10"],
...
},
{
  ...
  "POSSIBLE_ANSWERS": [
    ...
    "D. Porque o MDA não requer representação formal da arquitetura."
  ],
  "EXPLANATION_TEXT": "Explicação: O Padrão TOGAF® permite o uso de diversas linguagens de modelagem para que a representação da arquitetura possa se adaptar ao contexto da organização.",
  "CORRECT_ANSWER": "A",
  "JSONINDEX": "82",
  "Probability": 1,
  "versions": ["10"],
...
{
  "QUESTION_NUMBER": "83",
  "QUESTION_TEXT": "O que define quais informações a Capacidade de Arquitetura deve ter “à mão”, segundo o Padrão TOGAF®?",
  "POSSIBLE_ANSWERS": [
...
},
{
  ...
  "POSSIBLE_ANSWERS": [
    ...
    "B. Coletar o máximo de informações para evitar lacunas futuras e necessidades de levantamento.",
    "C. Expandir continuamente o escopo de modelos e relacionamentos.",
    "D. Centralizar todas as respostas em um único diagrama geral para que todas as informações estejam facilmente acessíveis."
  ],
  "EXPLANATION_TEXT": "Explicação: Recomenda-se separar o mínimo obrigatório “à mão” daquilo que é “sob demanda”, mantendo rastreabilidade e foco no propósito.",
  "CORRECT_ANSWER": "A",
  "JSONINDEX": "85",
  "Probability": 1,
  "versions": ["10"],
...
},
{
  ...
  "EXPLANATION_TEXT": "Explicação: As partes interessadas buscam respostas para suas questões; não precisam conhecer a estrutura do metamodelo em si.",
  "CORRECT_ANSWER": "B",
  "JSONINDEX": "86",
  "Probability": 1,
  "versions": ["10"],
...
},
{
  ...
  "POSSIBLE_ANSWERS": [
    ...
    "B. Adotar apenas UML e BPMN como padrão porque são linguagens amplamente conhecidas.",
  ...
  "EXPLANATION_TEXT": "Explicação: O Padrão TOGAF® recomenda testar catálogos, matrizes e diagramas para verificar se a informação é suficiente.",
  "CORRECT_ANSWER": "D",
  "JSONINDEX": "87",
  "Probability": 1,
  "versions": ["10"],
...
},
{
  ...
  "POSSIBLE_ANSWERS": [
    ...
    "C. Elimina-se a necessidade de modelos de capacidade e processo.",
    "D. Mantém-se o mesmo volume de informações."
  ],
  "EXPLANATION_TEXT": "Explicação: Ampliar o conjunto de questões expande os requisitos de informação e aumenta a complexidade do repositório.",
  "CORRECT_ANSWER": "A",
  "JSONINDEX": "88",
  "Probability": 1,
  "versions": ["10"],
...
},
{
  ...
  "EXPLANATION_TEXT": "Explicação: O Ponto de Vista define a perspectiva, as convenções e o recorte da arquitetura, enquanto a Visão é a representação concreta construída com base nesse esquema para responder às preocupações das partes interessadas.",
  "CORRECT_ANSWER": "D",
  "JSONINDEX": "91",
  "Probability": 1,
  "versions": ["9", "10"],
...

{
  ...
  "POSSIBLE_ANSWERS": [
    ...
    "C. Capturar o máximo de informações possível para futuras análises.",
    "D. Criar modelos adicionais sempre que houver tempo disponível."
  ],
  "EXPLANATION_TEXT": "Explicação: Um Repositório de Arquitetura sustentável depende da minimização rigorosa da informação coletada e mantida. Devem ser registrados apenas os elementos necessários para apoiar o projeto atual e garantir a rastreabilidade mínima exigida.",
  "CORRECT_ANSWER": "A",
  "JSONINDEX": "92",
  "Probability": 1,
  "versions": ["10"],
...

{
  ...
  "EXPLANATION_TEXT": "Explicação: O uso de Pontos de Vista previamente definidos reduz o esforço do arquiteto, acelera a criação das Visões e melhora a compreensão das partes interessadas, que passam a lidar com formatos consistentes e familiares. Isso também aumenta a confiança na validade das representações arquiteturais.",
  "CORRECT_ANSWER": "B",
  "JSONINDEX": "93",
  "Probability": 1,
  "versions": ["9", "10"],
...
},
{
  ...
  "POSSIBLE_ANSWERS": [
    "A. Criar um novo Ponto de Vista ou uma Visão ad hoc e depois avaliar se o Ponto de Vista deve ser incluído na biblioteca.",
    "B. Ignorar a necessidade até que a biblioteca de Pontos de Vista seja atualizada.",
    "C. Reaproveitar qualquer Ponto de Vista anterior, mesmo que não trate da preocupação correta.",
    "D. Solicitar aprovação prévia da parte interessada antes de produzir a Visão."
  ],
  "EXPLANATION_TEXT": "Explicação: Na ausência de um Ponto de Vista predefinido, o arquiteto pode criar um novo Ponto de Vista ou produzir uma Visão de acordo com as necessidades daquela situação (ad hoc). Posteriormente, avalia-se se esse Ponto de Vista deve ser formalizado e incorporado à biblioteca.",
  "CORRECT_ANSWER": "A",
  "JSONINDEX": "94",
  "Probability": 1,
  "versions": ["9", "10"],
...
{
  "QUESTION_NUMBER": "96",
  "QUESTION_TEXT": "Sobre os artefatos que podem compor o Continuum Corporativo, qual afirmação está correta?",
  "POSSIBLE_ANSWERS": [
    "A. Ele inclui apenas modelos criados dentro da organização.",
    "B. Ele aceita apenas BCSs, nunca BCAs.",
    "C. Ele exclui padrões de arquitetura que ainda estejam emergindo.",
    "D. Ele inclui artefatos internos e externos, desde o TRM até modelos de consórcios setoriais."
  ],
  "EXPLANATION_TEXT": "Explicação: O Continuum Corporativo inclui artefatos internos e externos, abrangendo desde modelos de referência amplamente aceitos, como o TRM, até arquiteturas e modelos desenvolvidos por consórcios da indústria. O Continuum Corporativo é dividido em Continuum de arquitetura que abarca os Blocos de Construção de Arquitetura (BCAs) e o Continuum de Soluções que organiza os Blocos de Construção de Solução (BCSs).",
  "CORRECT_ANSWER": "D",
  "JSONINDEX": "96",
  "Probability": 1,
  "versions": ["9", "10"],
...
{
  "QUESTION_NUMBER": "97",
  "QUESTION_TEXT": "Qual é o benefício principal de compreender em que ponto do Continuum Corporativo a organização se encontra?",
  "POSSIBLE_ANSWERS": [
    "A. Evitar discussões desencontradas durante debates arquiteturais.",
    "B. Facilitar auditorias financeiras.",
    "C. Reduzir a quantidade de artefatos exigidos pelo MDA.",
    "D. Eliminar a necessidade de arquiteturas específicas da organização."
  ],
  "EXPLANATION_TEXT": "Explicação: O Padrão TOGAF® destaca que a falta de entendimento sobre o posicionamento no Continuum Corporativo leva as pessoas a discutirem a arquitetura em níveis distintos de abstração, resultando em conversas sem alinhamento.",
  "CORRECT_ANSWER": "A",
  "JSONINDEX": "97",
  "Probability": 1,
  "versions": ["9", "10"],
...
{
  "QUESTION_NUMBER": "98",
  "QUESTION_TEXT": "O Continuum Corporativo apoia a reutilização ao permitir que a organização:",
  "POSSIBLE_ANSWERS": [
  ...
  "EXPLANATION_TEXT": "Explicação: O Continuum Corporativo organiza e classifica ativos arquiteturais reutilizáveis, internos ou externos, facilitando sua aplicação em diferentes contextos e maximizando o valor gerado pela arquitetura.",
  "CORRECT_ANSWER": "C",
  "JSONINDEX": "98",
  "Probability": 1,
  "versions": ["9", "10"],
...

{
  ...
  "EXPLANATION_TEXT": "Explicação: O Padrão TOGAF® define risco como o efeito da incerteza sobre os objetivos, considerando possíveis desvios positivos ou negativos em relação ao que é esperado.",
  "CORRECT_ANSWER": "D",
  "JSONINDEX": "99",
  "Probability": 1,
  "versions": ["9", "10"],
...
},
{
  ...
  "EXPLANATION_TEXT": "Explicação: A mitigação de riscos é contínua porque os gatilhos de risco podem surgir fora do escopo direto dos planejadores de transformação, exigindo monitoramento constante do contexto.",
  "CORRECT_ANSWER": "B",
  "JSONINDEX": "100",
  "Probability": 1,
  "versions": ["10"],
...
},
{
  ...
  "EXPLANATION_TEXT": "Explicação: O nível inicial de risco é categorizado antes da definição e implementação das ações de mitigação, enquanto o risco residual é avaliado após essas ações.",
  "CORRECT_ANSWER": "C",
  "JSONINDEX": "101",
  "Probability": 1,
  "versions": ["9", "10"],
...
},
{
  ...
  "EXPLANATION_TEXT": "Explicação: Após a identificação dos riscos, o processo de gerenciamento prevê a realização da avaliação inicial de risco, antes da definição das ações de mitigação.",
  "CORRECT_ANSWER": "B",
  "JSONINDEX": "102",
  "Probability": 1,
  "versions": ["9", "10"],
...
},
{
  ...
  "EXPLANATION_TEXT": "Explicação: O Padrão TOGAF® estabelece que, embora riscos possam ser identificados e mitigados pelos arquitetos, eles precisam ser formalmente aceitos dentro da estrutura de governança antes de serem gerenciados.",
  "CORRECT_ANSWER": "D",
  "JSONINDEX": "103",
  "Probability": 1,
  "versions": ["10"],
...
},
{
  ...
  "EXPLANATION_TEXT": "Explicação: O risco pode ser observado nos níveis estratégico, tático (programas e projetos) e operacional, sempre orientado de cima para baixo a partir do valor de negócio.",
  "CORRECT_ANSWER": "C",
  "JSONINDEX": "104",
  "Probability": 1,
  "versions": ["10"],
...
},
{
  ...
  "EXPLANATION_TEXT": "Explicação: O gerenciamento de riscos busca otimizar os resultados de negócio, maximizando o valor e minimizando perdas decorrentes da incerteza.",
  "CORRECT_ANSWER": "D",
  "JSONINDEX": "105",
  "Probability": 1,
  "versions": ["10"],
...
{
  "QUESTION_NUMBER": "106",
  "QUESTION_TEXT": "Qual alternativa lista exemplos de artefatos externos referenciados no Continuum Corporativo?",
  "POSSIBLE_ANSWERS": [
  ...
  "EXPLANATION_TEXT": "Explicação: O Continuum Corporativo inclui artefatos externos amplamente reconhecidos, como o TOGAF TRM, arquiteturas de referência SOA e modelos desenvolvidos por consórcios da indústria. Esses ativos podem ser reutilizados e adaptados conforme o contexto da organização.",
  "CORRECT_ANSWER": "C",
  "JSONINDEX": "99",
  "Probability": 1,
  "versions": ["9", "10"],
...
},
{
  ...
  "EXPLANATION_TEXT": "Explicação: A apresentação de alternativas e trade-offs ajuda a tornar explícitas agendas, princípios e requisitos que nem sempre estão claros inicialmente, mas que podem influenciar significativamente a Arquitetura Alvo final.",
  "CORRECT_ANSWER": "D",
  "JSONINDEX": "108",
  "Probability": 1,
  "versions": ["10"],
...
},
{
  ...
  "subject": "Trade-offs"
    ...
    {
        "QUESTION_NUMBER": "111",
        "QUESTION_TEXT": "Segundo a definição ISO/IEC/IEEE 42010:2011 adotada pelo Padrão TOGAF®, o que é arquitetura?",
        "POSSIBLE_ANSWERS": [
            "A. Um conjunto de processos operacionais usados para controlar mudanças organizacionais.",
            "B. Os conceitos ou propriedades fundamentais de um sistema em seu ambiente, expressos em seus elementos, relacionamentos e princípios de design e evolução.",
            "C. Uma coleção de componentes técnicos organizados para apoiar exclusivamente a infraestrutura de TI.",
            "D. Um método de documentação usado para registrar decisões de governança corporativa."
        ],
        "EXPLANATION_TEXT": "Explicação: A definição da ISO/IEC/IEEE 42010:2011 descreve arquitetura como os conceitos ou propriedades fundamentais de um sistema em seu ambiente, incorporados em seus elementos, relacionamentos e nos princípios de seu design e evolução.",
        "CORRECT_ANSWER": "B",
        "JSONINDEX": "111",
        "Probability": 1.0,
        "versions": ["9"],
    ...
    {
        "QUESTION_NUMBER": "112",
        "QUESTION_TEXT": "Além da definição da ISO/IEC/IEEE 42010:2011, o Padrão TOGAF® também define arquitetura como:",
        "POSSIBLE_ANSWERS": [
            "A. Um catálogo de requisitos de negócio, dados, aplicações e tecnologia.",
            "B. Um processo de governança usado para aprovar mudanças arquiteturais.",
            "C. Uma técnica para representar visualmente os componentes de uma solução.",
            "D. A estrutura de componentes, seus inter-relacionamentos, e os princípios e diretrizes que governam seu design e evolução ao longo do tempo."
        ],
        "EXPLANATION_TEXT": "Explicação: O Padrão TOGAF® apresenta uma segunda definição de arquitetura, dependendo do contexto: a estrutura de componentes, seus inter-relacionamentos, e os princípios e diretrizes que governam seu design e evolução ao longo do tempo.",
        "CORRECT_ANSWER": "D",
        "JSONINDEX": "112",
        "Probability": 1.0,
        "versions": ["9"],
    ...
    {
        "QUESTION_NUMBER": "113",
        "QUESTION_TEXT": "No contexto do Padrão TOGAF®, como a empresa é considerada?",
        "POSSIBLE_ANSWERS": [
            "A. Como um sistema.",
            "B. Como um conjunto de projetos independentes.",
            "C. Como uma coleção de aplicações de negócio.",
            "D. Como uma unidade exclusivamente organizacional."
        ],
        "EXPLANATION_TEXT": "Explicação: O Padrão TOGAF® considera a empresa como um sistema. Essa visão permite aplicar o conceito de arquitetura ao contexto da empresa, seus elementos, relacionamentos e evolução.",
        "CORRECT_ANSWER": "A",
        "JSONINDEX": "113",
        "Probability": 1.0,
        "versions": ["9"],
    ...
    },
    {
        ...
        "EXPLANATION_TEXT": "Explicação: O Padrão TOGAF® procura equilibrar conceitos e terminologia derivados de padrões relevantes com uma terminologia comumente aceita e familiar à maioria dos seus leitores.",
        "CORRECT_ANSWER": "C",
        "JSONINDEX": "114",
        "Probability": 1.0,
        "versions": ["9"],
    ...
    {
        "QUESTION_NUMBER": "115",
        "QUESTION_TEXT": "Uma organização iniciou uma iniciativa de Arquitetura Corporativa após perceber que seus processos manuais e automatizados estavam fragmentados, com pouca integração entre áreas e baixa capacidade de resposta a mudanças estratégicas. Segundo o Padrão TOGAF®, qual é o principal propósito dessa iniciativa?",
        "POSSIBLE_ANSWERS": [
            "A. Criar uma documentação completa de todos os sistemas existentes, independentemente da estratégia organizacional.",
            "B. Substituir todos os processos manuais por soluções automatizadas, reduzindo a dependência de pessoas.",
            "C. Otimizar o legado de processos em um ambiente integrado, responsivo à mudança e capaz de apoiar a entrega da estratégia de negócio.",
            "D. Centralizar todas as decisões operacionais na área de tecnologia, garantindo maior controle técnico sobre a organização."
        ],
        "EXPLANATION_TEXT": "Explicação: O propósito da Arquitetura Corporativa, segundo o Padrão TOGAF®, é otimizar o legado de processos da corporação, frequentemente fragmentado, tanto manual quanto automatizado, transformando-o em um ambiente integrado, responsivo à mudança e capaz de apoiar a entrega da estratégia de negócio.",
        "CORRECT_ANSWER": "C",
        "JSONINDEX": "115",
        "Probability": 1.0,
        "versions": ["9", "10"],
    ...
    {
        "QUESTION_NUMBER": "116",
        "QUESTION_TEXT": "Uma empresa trata sua Arquitetura Corporativa apenas como um conjunto de diagramas criados para atender a uma auditoria. Depois da entrega dos documentos, os modelos não são mais atualizados e deixam de refletir a realidade da organização. Qual entendimento do Padrão TOGAF® foi negligenciado?",
        "POSSIBLE_ANSWERS": [
            "A. A Arquitetura Corporativa deve ser também uma prática contínua de gestão e evolução da arquitetura em diferentes níveis de controle, mudança e ritmo.",
            "B. A Arquitetura Corporativa deve eliminar a necessidade de governança, pois os diagramas já indicam como a organização funciona.",
            "C. A Arquitetura Corporativa deve se limitar à descrição dos sistemas de informação, pois mudanças organizacionais pertencem à gestão de projetos.",
            "D. A Arquitetura Corporativa deve ser criada apenas uma vez, desde que a documentação inicial seja suficientemente detalhada."
        ],
        "EXPLANATION_TEXT": "Explicação: A Arquitetura Corporativa não é apenas uma descrição estática dos elementos da organização. Segundo o Padrão TOGAF®, ela também é a prática de atuar para gerenciar e evoluir a arquitetura em todos os níveis de controle, mudança e ritmo. Por isso, tratá-la apenas como documentação de auditoria reduz indevidamente seu papel.",
        "CORRECT_ANSWER": "A",
        "JSONINDEX": "116",
        "Probability": 1.0,
        "versions": ["10"],
    ...
    {
        "QUESTION_NUMBER": "117",
        "QUESTION_TEXT": "Segundo o Padrão TOGAF®, uma Corporação pode incluir quais elementos?",
        "POSSIBLE_ANSWERS": [
            "A. Apenas unidades internas de negócio.",
            "B. Somente departamentos que pertencem juridicamente à mesma empresa.",
            "C. Apenas áreas diretamente subordinadas ao departamento de TI.",
            "D. Parceiros, fornecedores, clientes e unidades internas de negócio."
        ],
        "EXPLANATION_TEXT": "Explicação: No contexto de Arquitetura Corporativa, uma Enterprise pode incluir parceiros, fornecedores, clientes e unidades internas de negócio. O escopo da arquitetura pode atravessar vários sistemas e grupos funcionais.",
        "CORRECT_ANSWER": "D",
        "JSONINDEX": "117",
        "Probability": 1.0,
        "versions": ["9", "10"],
    ...
    {
        "QUESTION_NUMBER": "118",
        "QUESTION_TEXT": "Segundo o Padrão TOGAF®, a Arquitetura Corporativa é desenvolvida por qual razão principal?",
        "POSSIBLE_ANSWERS": [
            "A. Orientar mudanças efetivas.",
            "B. Criar diagramas detalhados de todos os sistemas.",
            "C. Eliminar a necessidade de governança organizacional.",
            "D. Padronizar todos os processos de desenvolvimento de software."
        ],
        "EXPLANATION_TEXT": "Explicação: A Arquitetura Corporativa é desenvolvida por uma razão central: orientar mudanças efetivas. A organização busca melhorar, e a arquitetura ajuda a conduzir essa mudança de forma deliberada e alinhada ao valor esperado.",
        "CORRECT_ANSWER": "A",
        "JSONINDEX": "118",
        "Probability": 1.0,
        "versions": ["10"],
    ...
    {
        "QUESTION_NUMBER": "119",
        "QUESTION_TEXT": "Segundo o Padrão TOGAF®, qual alternativa expressa corretamente a definição de Arquitetura Corporativa?",
        "POSSIBLE_ANSWERS": [
            "A. É uma documentação técnica dos sistemas da organização, usada principalmente para registrar aplicações, dados e infraestrutura.",
            "B. É um método de gestão de projetos voltado para controlar cronogramas, custos e entregas de iniciativas de transformação.",
            "C. É um conjunto de diagramas que descreve a situação atual da empresa e deve ser atualizado ao final de cada grande projeto.",
            "D. É a descrição dos elementos da organização, a estrutura para gerenciar mudanças nesses elementos e a prática de gerir e evoluir a arquitetura em diferentes níveis de controle, mudança e ritmo."
        ],
        "EXPLANATION_TEXT": "Explicação: Segundo o Padrão TOGAF®, a Arquitetura Corporativa envolve três aspectos complementares: a descrição dos elementos da organização, uma estrutura para gerenciar mudanças nesses elementos e a prática de atuar para gerir e evoluir a arquitetura em todos os níveis de controle, mudança e ritmo. Portanto, ela não se limita a documentação, diagramas ou gestão de projetos.",
        "CORRECT_ANSWER": "D",
        "JSONINDEX": "119",
        "Probability": 1.0,
        "versions": ["10"],
